...
namespace Backend.Test.Mocks
{
    public class MockData
    {
        public static List<User> Users = new List<User> {
            ...
            new User { Id = 4, IsCompany=true,  CompanyName = "UAB „Ne įmonė“", CompanyCode = "567891", UserName = "company5@example.com", NormalizedUserName = "COMPANY5@EXAMPLE.COM", Email = "company5@example.com", EmailConfirmed = false, NormalizedEmail = "COMPANY5@EXAMPLE.COM", PasswordHash = "AQAAAAEAACcQAAAAEK4hVsHx9G6FTUDDlJaY/l1aRXqpoUZU9nkEkvECUI2uQ+FHoFYHjlJpmP3KOss/qg==", SecurityStamp = Guid.NewGuid().ToString()}
            new User { Id = 5, IsCompany=true,  CompanyName = "UAB „Vieša įmonė“", CompanyCode = "678912", UserName = "company6@example.com", NormalizedUserName = "COMPANY6@EXAMPLE.COM", Email = "company6@example.com", EmailConfirmed = false, NormalizedEmail = "COMPANY6@EXAMPLE.COM", PasswordHash = "AQAAAAEAACcQAAAAEK4hVsHx9G6FTUDDlJaY/l1aRXqpoUZU9nkEkvECUI2uQ+FHoFYHjlJpmP3KOss/qg==", SecurityStamp = Guid.NewGuid().ToString()},
        };
